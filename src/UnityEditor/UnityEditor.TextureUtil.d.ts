declare namespace UnityEditor {
  class TextureUtil {
    ...
    static SetSourceTexture(cubemapRef: any, face: any, tex: any): any;
    static CopyTextureIntoCubemapFace(textureRef: any, cubemapRef: any, face: any): any;
    static CopyCubemapFaceIntoTexture(cubemapRef: any, face: any, textureRef: any): any;
    ...
    static SetAnisoLevelNoDirty(tex: any, level: number): any;
    static SetWrapModeNoDirty(tex: any, mode: any): any;
    static SetMipMapBiasNoDirty(tex: any, bias: number): any;
    static SetFilterModeNoDirty(tex: any, mode: any): any;
    static DoesTextureStillNeedToBeCompressed(assetPath: string): boolean;
    static IsCubemapReadable(cubemapRef: any): boolean;
    static MarkCubemapReadable(cubemapRef: any, readable: boolean): any;
