declare namespace UnityEditor {
  class ClothInspector {
    ...
    OnInspectorGUI(): any;
    OnSceneGUI(): any;
    VisualizationMenuSetMaxDistanceMode(): any;
    VisualizationMenuSetCollisionSphereMode(): any;
    VisualizationMenuToggleManipulateBackfaces(): any;
    DrawColorBox(gradientTex: any, col: any): any;
