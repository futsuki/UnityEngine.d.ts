declare namespace UnityEditor {
  class PaneDragTab {
    ...
    constructor();
    // methods
    SetDropInfo(di: UnityEditor.DropInfo, mouseScreenPos: any, inFrontOf: UnityEditor.ContainerWindow): any;
    Close(): any;
    Show(pixelPos: any, content: any, viewSize: any, mouseScreenPosition: any): any;
