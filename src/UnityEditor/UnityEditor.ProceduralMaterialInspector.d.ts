declare namespace UnityEditor {
  class ProceduralMaterialInspector {
    ...
    constructor();
    // methods
    DisableReimportOnDisable(): any;
    ReimportSubstances(): any;
    Awake(): any;
    OnEnable(): any;
    ReimportSubstancesIfNeeded(): any;
    OnDisable(): any;
    ...
    static ResetSubstance(command: UnityEditor.MenuCommand): any;
    static ExportBitmapsAlphaRemap(command: UnityEditor.MenuCommand): any;
    static ExportBitmapsNoAlphaRemap(command: UnityEditor.MenuCommand): any;
    static ExportPreset(command: UnityEditor.MenuCommand): any;
    BuildTargetList(): any;
    ShowTextureSizeGUI(): any;
