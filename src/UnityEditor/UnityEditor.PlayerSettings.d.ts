declare namespace UnityEditor {
  class PlayerSettings {
    ...
    constructor();
    // methods
    static SetPropertyInt(name: string, value: number, target: UnityEditor.BuildTargetGroup): any;
    static SetPropertyInt(name: string, value: number): any;
    static SetPropertyInt(name: string, value: number, target: UnityEditor.BuildTarget): any;
    ...
    static SetPropertyBool(name: string, value: boolean, target: UnityEditor.BuildTargetGroup): any;
    static SetPropertyBool(name: string, value: boolean): any;
    static SetPropertyBool(name: string, value: boolean, target: UnityEditor.BuildTarget): any;
    ...
    static SetPropertyString(name: string, value: string, target: UnityEditor.BuildTargetGroup): any;
    static SetPropertyString(name: string, value: string): any;
    static SetPropertyString(name: string, value: string, target: UnityEditor.BuildTarget): any;
    ...
    static SetAspectRatio(aspectRatio: UnityEditor.AspectRatio, enable: boolean): any;
    static GetIconsForTargetGroup(platform: UnityEditor.BuildTargetGroup): any[];
    static SetIconsForTargetGroup(platform: UnityEditor.BuildTargetGroup, icons: any[]): any;
    ...
    static SetGraphicsAPIs(platform: UnityEditor.BuildTarget, apis: any[]): any;
    static GetUseDefaultGraphicsAPIs(platform: UnityEditor.BuildTarget): boolean;
    static SetUseDefaultGraphicsAPIs(platform: UnityEditor.BuildTarget, automatic: boolean): any;
    static GetScriptingDefineSymbolsForGroup(targetGroup: UnityEditor.BuildTargetGroup): string;
    static SetScriptingDefineSymbolsForGroup(targetGroup: UnityEditor.BuildTargetGroup, defines: string): any;
    static GetArchitecture(targetGroup: UnityEditor.BuildTargetGroup): number;
    static SetArchitecture(targetGroup: UnityEditor.BuildTargetGroup, architecture: number): any;
    static GetScriptingBackend(targetGroup: UnityEditor.BuildTargetGroup): UnityEditor.ScriptingImplementation;
    static SetScriptingBackend(targetGroup: UnityEditor.BuildTargetGroup, backend: UnityEditor.ScriptingImplementation): any;
    static GetIncrementalIl2CppBuild(targetGroup: UnityEditor.BuildTargetGroup): boolean;
    static SetIncrementalIl2CppBuild(targetGroup: UnityEditor.BuildTargetGroup, enabled: boolean): any;
    static GetAdditionalIl2CppArgs(): string;
    static SetAdditionalIl2CppArgs(additionalArgs: string): any;
    static GetStackTraceLogType(logType: any): any;
    static SetStackTraceLogType(logType: any, stackTraceType: any): any;
    ToString(): string;
